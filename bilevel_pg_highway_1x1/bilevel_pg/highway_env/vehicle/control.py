...
class ControlledVehicle(Vehicle):
    ...
    def __init__(self,
                 ...
                 route=None):
        super(ControlledVehicle, self).__init__(road, position, index, heading, velocity)
...
class MDPVehicle(ControlledVehicle):
    ...
    def __init__(self,
                 ...
                 target_velocity=None,
                 route=None):
        super(MDPVehicle, self).__init__(road, position, index, heading, velocity, target_lane_index, target_velocity, route)
