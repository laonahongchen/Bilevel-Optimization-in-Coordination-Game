...
class MatrixGame(BaseGame):
    def __init__(self, game_name, agent_num, action_num, payoff=None, repeated=False, max_step=25, memory=0, discrete_action=True, tuple_obs=False):
        ...
        if self.game_name == 'coordination_0_0':
            ...
            self.payoff[0] = [[18, 15, 13, 0],
                              [15, 13, 10, 0],
                              [13, 10, 8, 0],
                              [0, 0, 0, 50]]
            self.payoff[1] = [[18, 15, 13, 0],
                              [15, 13, 10, 0],
                              [13, 10, 8, 0],
                              [0, 0, 0, 50]]
        elif self.game_name == 'climbing_3x3':
            self.payoff[0] = [[20, 15, 0],
                              [10, 15, 0],
                              [ 0,  0, 70]]
            self.payoff[1] = [[20, 15, 0],
                              [10, 15, 0],
                              [ 0,  0, 70]]    
    ...
    def get_game_list():
        return {
            ...
            'climbing': {'agent_num': 2, 'action_num': 4},
            'climbing_3x3': {'agent_num': 2, 'action_num': 3},
