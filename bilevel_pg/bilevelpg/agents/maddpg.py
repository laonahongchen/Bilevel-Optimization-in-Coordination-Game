...
class MADDPGAgent(OffPolicyAgent):
    def __init__(self,
                 ...
                 qf,
                 replay_buffer,
                 policy_optimizer=tf.optimizers.Adam(lr=0.010),
    ...
    def critic_loss(self,
        ...
        critic_net_input = [observations, np.concatenate((actions, opponent_actions, inner_products), 1)]
    ...
    def actor_loss(self, observations, opponent_actions, weights=None):
        ...
        actions = tf.concat((actions, opponent_actions, actions * actions, actions * opponent_actions, opponent_actions * opponent_actions), 1)
        print(actions.shape)
